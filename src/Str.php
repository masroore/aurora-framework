...
class Str
{
    ...
    public static function afterLast($subject, $search)
    {
        ...
        return false === $pos ? $subject : static::substr($subject, $pos + 1);
    }
    ...
    public static function beforeLast($subject, $search)
    {
        ...
        return false === $pos ? $subject : static::substr($subject, 0, $pos);
    }
    ...
    public static function slug($title, $separator = '-', $language = 'en')
    {
        ...
        $title = preg_replace(sprintf('![%s]+!u', preg_quote($flip, null)), $separator, $title);

        // Replace @ with the word 'at'
        $title = str_replace('@', $separator . 'at' . $separator, $title);

        // Remove all characters that are not the separator, letters, numbers, or whitespace.
        $title = preg_replace(sprintf('![^%s\\pL\\pN\\s]+!u', preg_quote($separator, null)), '', mb_strtolower($title));

        // Replace all separator characters and whitespace by a single separator
        $title = preg_replace(sprintf('![%s\\s]+!u', preg_quote($separator, null)), $separator, $title);
