...
class Redirect extends Response
{
    ...
    {
        return static::to(Url::action($action, $parameters), $status);
    }
    ...
    {
        return static::to(Url::route($route, $parameters), $status);
    }
     ...
     *        return Redirect::to('login')->withInput('only', array('email', 'username'));
     *
     *        // Redirect and flash all but a few of the input items
     *        return Redirect::to('login')->withInput('except', array('password', 'ssn'));
     * </code>
     *
     * @param string $filter
     * @param array  $items
     ...
     * @return Redirect
     */
    public function withInput($filter = null, $items = [])
    {
     ...
     * </code>
     *
     * @param Messages|Validator $container
     *
     * @return Redirect
     */
    public function withErrors($container)
    {
