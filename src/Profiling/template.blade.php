<!-- ANBU - AURORA PROFILER -->
<style type="text/css">{{ file_get_contents(SYS_PATH.'profiling/profiler.css') }}</style>
<div class="anbu">
                    ...
                    <table>
                        ...
                        @foreach ($timers as $name => $timer)
                            <tr>
                                ...
                                <td>
                                    <pre>{{ $timer['running_time'] }}ms (time from start to render)</pre>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            @else
                                <tr>
                                    <td>
                                        <pre>Running Time</pre>
                                    </td>
                                    <td>
                                        <pre>{{ $timer['time'] }}ms</pre>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                            @endif
    ...
    <ul id="anbu-open-tabs" class="anbu-tabs">
        <li><a data-anbu-tab="anbu-log" class="anbu-tab" href="#">Log <span class="anbu-count">{{ count($logs) }}</span></a>
        </li>
        <li>
        ...
        <li><a class="anbu-tab" data-anbu-tab="anbu-checkpoints">Time <span class="anbu-count">{{ $time }}ms</span></a>
        </li>
...
<script>{{ file_get_contents(SYS_PATH.'profiling/profiler.js') }}</script>
<!-- /ANBU - AURORA PROFILER -->
